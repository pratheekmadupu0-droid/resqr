/**
 * OpenCV Helper for RESQR Facial Recognition
 */

export const extractFeatures = async (imgSource) => {
  if (!window.cv) {
...
export const matchFeatures = (queryDescriptors, database) => {
  ...
  for (const entry of database) {
    ...
    if (goodMatchesCount > maxMatches && goodMatchesCount > 25) { // Minimum consensus
